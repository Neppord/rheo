...
describe('rheo', function () {
  ...
  it('supports IE-fix comments', function (done) {
    var html_with_IE_comment = [
      '<head>',
      ...
      '  <link href="/static/css/ie8-fix.css" rel="stylesheet">',
      '<![endif]-->',
      '</head>'
    ].join('\n')
    checker(done, html_with_IE_comment)(rheo(html_with_IE_comment).render())
  })
})
